...
[TRACE][ecs/src/ecs/mod.rs::239] files: [
    "[CWD]/.xvc/ec/1691434456876461",
    "[CWD]/.xvc/ec/1691434456880001",
    "[CWD]/.xvc/ec/1691434456955593",
    "[CWD]/.xvc/ec/1691434457028981",
]
...
[TRACE][walker/src/notify.rs::160] watcher: FsEventWatcher {
    paths: 0x0000600000e940f0,
    since_when: 18446744073709551615,
    latency: 0.0,
    flags: 18,
    event_handler: 0x0000600003194150,
    runloop: Some(
        (
            0x0000600003c90100,
            JoinHandle { .. },
...
[TRACE][pipeline/src/pipeline/mod.rs::628] select: Select { .. }
...
[TRACE][pipeline/src/pipeline/mod.rs::667] params.recorded_dependencies: R1NStore {
    parents: XvcStore {
        map: {
            XvcEntity(
                2,
...
[TRACE][pipeline/src/pipeline/mod.rs::668] step_e: XvcEntity(
    2,
    9132409476247426234,
)
[TRACE][pipeline/src/pipeline/mod.rs::609] dep_neighbors: Neighbors {
    iter: Iter(
        [],
    ),
    ty: PhantomData<petgraph::Directed>,
}
[TRACE][pipeline/src/pipeline/mod.rs::669] dependencies(step_e, params.dependency_graph)?: {}
[TRACE][pipeline/src/pipeline/mod.rs::609] dep_neighbors: Neighbors {
    iter: Iter(
        [],
    ),
...
[TRACE][pipeline/src/pipeline/mod.rs::708] &step_state: Begin(
    FromInit,
)
[TRACE][pipeline/src/pipeline/mod.rs::826] step.name: "morning-message"
[TRACE][pipeline/src/pipeline/mod.rs::628] select: Select { .. }
[TRACE][pipeline/src/pipeline/mod.rs::827] &r_next_state: WaitingDependencySteps(
    FromRunConditional,
)
[TRACE][pipeline/src/pipeline/mod.rs::829] &step_state: WaitingDependencySteps(
    FromRunConditional,
)
[TRACE][pipeline/src/pipeline/mod.rs::708] &step_state: WaitingDependencySteps(
    FromRunConditional,
)
[TRACE][pipeline/src/pipeline/mod.rs::628] select: Select { .. }
[TRACE][pipeline/src/pipeline/mod.rs::826] step.name: "morning-message"
[TRACE][pipeline/src/pipeline/mod.rs::827] &r_next_state: CheckingOutputs(
    FromDependencyStepsFinishedSuccessfully,
)
[TRACE][pipeline/src/pipeline/mod.rs::829] &step_state: CheckingOutputs(
    FromDependencyStepsFinishedSuccessfully,
)
[TRACE][pipeline/src/pipeline/mod.rs::708] &step_state: CheckingOutputs(
    FromDependencyStepsFinishedSuccessfully,
)
[TRACE][pipeline/src/pipeline/mod.rs::628] select: Select { .. }
[TRACE][pipeline/src/pipeline/mod.rs::826] step.name: "morning-message"
[TRACE][pipeline/src/pipeline/mod.rs::827] &r_next_state: CheckingSuperficialDiffs(
    FromCheckedOutputs,
)
[TRACE][pipeline/src/pipeline/mod.rs::829] &step_state: CheckingSuperficialDiffs(
    FromCheckedOutputs,
)
[TRACE][pipeline/src/pipeline/mod.rs::708] &step_state: CheckingSuperficialDiffs(
    FromCheckedOutputs,
)
[TRACE][pipeline/src/pipeline/mod.rs::1113] params.step_dependencies.len(): 0
[TRACE][pipeline/src/pipeline/mod.rs::1116] params.step.name: "morning-message"
[TRACE][pipeline/src/pipeline/mod.rs::826] step.name: "morning-message"
[TRACE][pipeline/src/pipeline/mod.rs::628] select: Select { .. }
[TRACE][pipeline/src/pipeline/mod.rs::827] &r_next_state: CheckingThoroughDiffs(
    FromSuperficialDiffsChanged,
)
[TRACE][pipeline/src/pipeline/mod.rs::829] &step_state: CheckingThoroughDiffs(
    FromSuperficialDiffsChanged,
)
[TRACE][pipeline/src/pipeline/mod.rs::708] &step_state: CheckingThoroughDiffs(
    FromSuperficialDiffsChanged,
)
[TRACE][pipeline/src/pipeline/mod.rs::1164] deps: {}
[TRACE][pipeline/src/pipeline/mod.rs::628] select: Select { .. }
[TRACE][pipeline/src/pipeline/mod.rs::1165] deps.is_empty(): true
[TRACE][pipeline/src/pipeline/mod.rs::826] step.name: "morning-message"
[TRACE][pipeline/src/pipeline/mod.rs::827] &r_next_state: ComparingDiffsAndOutputs(
    FromThoroughDiffsChanged,
)
[TRACE][pipeline/src/pipeline/mod.rs::829] &step_state: ComparingDiffsAndOutputs(
    FromThoroughDiffsChanged,
)
[TRACE][pipeline/src/pipeline/mod.rs::708] &step_state: ComparingDiffsAndOutputs(
    FromThoroughDiffsChanged,
)
[TRACE][pipeline/src/pipeline/mod.rs::628] select: Select { .. }
[TRACE][pipeline/src/pipeline/mod.rs::826] step.name: "morning-message"
[TRACE][pipeline/src/pipeline/mod.rs::827] &r_next_state: WaitingToRun(
    FromDiffsHasChanged,
)
[TRACE][pipeline/src/pipeline/mod.rs::829] &step_state: WaitingToRun(
    FromDiffsHasChanged,
)
[TRACE][pipeline/src/pipeline/mod.rs::708] &step_state: WaitingToRun(
    FromDiffsHasChanged,
)
[TRACE][pipeline/src/pipeline/mod.rs::628] select: Select { .. }
...
[TRACE][pipeline/src/pipeline/mod.rs::826] step.name: "morning-message"
[TRACE][pipeline/src/pipeline/mod.rs::827] &r_next_state: Running(
    FromStartProcess,
)
[TRACE][pipeline/src/pipeline/mod.rs::829] &step_state: Running(
    FromStartProcess,
)
[TRACE][pipeline/src/pipeline/mod.rs::708] &step_state: Running(
    FromStartProcess,
)
[TRACE][pipeline/src/pipeline/mod.rs::628] select: Select { .. }
[TRACE][pipeline/src/pipeline/mod.rs::826] step.name: "morning-message"
...
[TRACE][pipeline/src/pipeline/mod.rs::826] step.name: "morning-message"
[TRACE][pipeline/src/pipeline/mod.rs::827] &r_next_state: DoneByRunning(
    FromProcessCompletedSuccessfully,
)
[TRACE][pipeline/src/pipeline/mod.rs::829] &step_state: DoneByRunning(
    FromProcessCompletedSuccessfully,
)
[TRACE][pipeline/src/pipeline/mod.rs::708] &step_state: DoneByRunning(
    FromProcessCompletedSuccessfully,
)
[TRACE][pipeline/src/pipeline/mod.rs::628] select: Select { .. }
