...
[TRACE][ecs/src/ecs/mod.rs::239] files: [
    "[CWD]/.xvc/ec/1690967258258559",
    "[CWD]/.xvc/ec/1690967258261730",
    "[CWD]/.xvc/ec/1690967258332127",
    "[CWD]/.xvc/ec/1690967258403225",
    "[CWD]/.xvc/ec/1690967258476483",
]
...
[TRACE][walker/src/notify.rs::160] watcher: FsEventWatcher {
    paths: 0x00006000028601e0,
    since_when: 18446744073709551615,
    latency: 0.0,
    flags: 18,
    event_handler: 0x000060000176c010,
    runloop: Some(
        (
            0x0000600001a64800,
            JoinHandle { .. },
...
[TRACE][pipeline/src/pipeline/mod.rs::331] &dependency_graph: {
    XvcEntity(
        2,
        13141519431038050006,
    ): [
        (
            XvcEntity(
                3,
                13488746673592548293,
            ),
            Outgoing,
        ),
    ],
...
digraph {
    0 [ label = "(2, 13141519431038050006)" ]
    1 [ label = "(3, 13488746673592548293)" ]
    0 -> 1 [ label = "Step" ]
}
...
[TRACE][pipeline/src/pipeline/mod.rs::625] select: Select { .. }
[TRACE][pipeline/src/pipeline/mod.rs::1110] params.step_dependencies.len(): 1
[TRACE][pipeline/src/pipeline/mod.rs::1137] changed: false
[TRACE][pipeline/src/pipeline/mod.rs::823] step.name: "world"
[TRACE][pipeline/src/pipeline/mod.rs::824] &r_next_state: ComparingDiffsAndOutputs(
...
[TRACE][pipeline/src/pipeline/mod.rs::1098] changed: true
[TRACE][pipeline/src/pipeline/mod.rs::823] step.name: "world"
[TRACE][pipeline/src/pipeline/mod.rs::824] &r_next_state: WaitingToRun(
    FromDiffsHasChanged,
)
