...
Benchmark 1: xvc init
  Time (abs ≡):         34.9 ms               [User: 11.9 ms, System: 20.1 ms]
 

$ hyperfine -r 1 'dvc init ; git add .dvc/ .dvcignore ; git commit -m "Init DVC"'
Benchmark 1: dvc init ; git add .dvc/ .dvcignore ; git commit -m "Init DVC"
  Time (abs ≡):        288.7 ms               [User: 204.9 ms, System: 75.7 ms]
...
Benchmark 1: xvc file track data/data/*.jpg
  Time (abs ≡):        31.324 s               [User: 30.306 s, System: 12.257 s]
...
Benchmark 1: dvc add data/data/*.jpg ; git add data/data/*.dvc ; git commit -m "Added data/data/ to DVC"
  Time (abs ≡):        196.937 s               [User: 149.884 s, System: 37.993 s]
...
```console
$ mkdir small-files
$ zsh -cl 'for i in {1..1000000} ; echo data-${i} > small-files/file-${i}.txt'
