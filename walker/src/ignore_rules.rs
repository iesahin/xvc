...
pub struct IgnoreRules {
    ...
    pub whitelist_set: Arc<RwLock<Glob>>,

    /// Compiled [GlobSet] for ignored paths.
    pub ignore_set: Arc<RwLock<Glob>>,
}
...
impl IgnoreRules {
    ...
    pub fn empty(dir: &Path) -> Self {
        IgnoreRules {
            ...
            ignore_set: Arc::new(RwLock::new(Glob::new("").expect("Empty glob is valid"))),
            whitelist_set: Arc::new(RwLock::new(Glob::new("").expect("Empty glob is valid"))),
        }
    }
