...
- `AWS_ACCESS_KEY_ID` or `XVC_STORAGE_ACCESS_KEY_ID_<storage_name>`: The access key of the Amazon Web Services
  account. The second form is used when you have multiple accounts and you want to use a specific one.
- `AWS_SECRET_ACCESS_KEY` or `XVC_STORAGE_SECRET_ACCESS_KEY_<storage_name>`: The secret key of the Amazon Web Services account. The second form is used when you have multiple accounts and you want to use a specific
  one.
